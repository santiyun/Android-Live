...
public class VideoProfileManager {
    ...
    public VideoProfileManager() {
        mVideoProfiles.add(new VideoProfile("超低质量", Constants.VIDEO_PROFILE_120P, 160, 120, 65, 15));
        mVideoProfiles.add(new VideoProfile("低质量", Constants.VIDEO_PROFILE_240P, 320, 240, 200, 15));
        mVideoProfiles.add(new VideoProfile("高质量", Constants.VIDEO_PROFILE_360P, 640, 360, 400, 15));
        mVideoProfiles.add(new VideoProfile("超高质量", Constants.VIDEO_PROFILE_480P, 640, 480, 500, 15));
        mVideoProfiles.add(new VideoProfile("特高质量", Constants.VIDEO_PROFILE_720P, 1280, 720, 1130, 15));
    }
